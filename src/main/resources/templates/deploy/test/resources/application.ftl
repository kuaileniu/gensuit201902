...
# 连接池中的最小空闲连接
  ...
  datasource:
    name: ${gen.dbName}
    url: jdbc:mysql://test-application-mysql:3306/${gen.dbName}?useUnicode=true&characterEncoding=UTF-8&useSSL=false&createDatabaseIfNotExist=true
    username: root
    password:
