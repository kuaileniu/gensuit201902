 ...
 *
 */
public class AlainRequestModel {
...
<#--    private int currentPage = 1;-->
    ...
    public AlainRequestModel setData(Map data) {
        this.data = data;
        return this;
    }
    ...
    public AlainRequestModel setSeq(String seq) {
        this.seq = seq;
        return this;
    }
    ...
    public AlainRequestModel setBack(Boolean back) {
        this.back = back;
        return this;
    }
    ...
    public AlainRequestModel setSameReturn(String sameReturn) {
    ...
    public AlainRequestModel setDtype(int dtype) {
        this.dtype = dtype;
        return this;
    }
    ...
    public AlainRequestModel setPageNo(int pageNo) {
        this.pageNo = pageNo;
        return this;
    }
    ...
    public AlainRequestModel setPageSize(int pageSize) {
    ...
    public AlainRequestModel setPermissionCodes(List<String> permissionCodes) {
    ...
    public AlainRequestModel setWhereItems(List<WhereItem> whereItems) {
        this.whereItems = whereItems;
        return this;
    }

    public AlainRequestModel addWhereItem(WhereItem whereItem) {
