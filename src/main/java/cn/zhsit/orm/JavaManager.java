...
//        solidObjectsList.add(new SolidObject(GenConstants.common_controller, GenConstants.COMMON_CONTROLLER_FTL, gen.getControllerPackage(), FileType.MavenMainJava));
        ...
        solidObjectsList.add(new SolidObject(GenConstants.RolePermissionChange, GenConstants.RolePermissionChange_FTL, gen.getDtoPackage(), FileType.MavenMainJava));
...
//            solidObjectsList.add(new SolidObject(GenConstants.KryoSerializer, GenConstants.KryoSerializer_FTL, gen.getIoPackage(), FileType.MavenMainJava));
        ...
        solidObjectsList.add(new SolidObject(GenConstants.AXssInterceptor, GenConstants.AXssInterceptor_FTL, gen.getInterceptorPackage(), FileType.MavenMainJava));
